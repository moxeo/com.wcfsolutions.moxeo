...
ALTER TABLE moxeo1_1_comment CHANGE commentObjectID commentableObjectID INT(10) NOT NULL DEFAULT 0;
ALTER TABLE moxeo1_1_comment CHANGE commentObjectType commentableObjectType VARCHAR(255) NOT NULL DEFAULT '';
