<fieldset>
	<legend>{lang}moxeo.acp.theme.module.navigation.data{/lang}</legend>
	
	<div class="formElement" id="levelOffsetDiv">
		<div class="formFieldLabel">
			<label for="levelOffset">{lang}moxeo.acp.theme.module.navigation.levelOffset{/lang}</label>
		</div>
		<div class="formField">
		...
		<div class="formFieldDesc hidden" id="levelOffsetHelpMessage">
			<p>{lang}moxeo.acp.theme.module.navigation.levelOffset.description{/lang}</p>
		</div>
	</div>
	...
	<div class="formElement" id="levelLimitDiv">
		<div class="formFieldLabel">
			<label for="levelLimit">{lang}moxeo.acp.theme.module.navigation.levelLimit{/lang}</label>
		</div>
		<div class="formField">
		...
		<div class="formFieldDesc hidden" id="levelLimitHelpMessage">
			<p>{lang}moxeo.acp.theme.module.navigation.levelLimit.description{/lang}</p>
		</div>
	</div>
	<script type="text/javascript">//<![CDATA[
