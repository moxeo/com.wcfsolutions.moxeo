<fieldset>
	<legend>{lang}wsis.acp.theme.module.search.data{/lang}</legend>
	
	<div class="formElement" id="itemsPerPageDiv">
		<div class="formFieldLabel">
			<label for="itemsPerPage">{lang}wsis.acp.theme.module.search.itemsPerPage{/lang}</label>
		</div>
		<div class="formField">
		...
		<div class="formFieldDesc hidden" id="itemsPerPageHelpMessage">
			<p>{lang}wsis.acp.theme.module.search.itemsPerPage.description{/lang}</p>
		</div>
	</div>
