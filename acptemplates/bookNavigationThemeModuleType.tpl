<fieldset>
	<legend>{lang}wsis.acp.theme.module.bookNavigation.data{/lang}</legend>
	
	<div class="formElement{if $errorField == 'contentItemID'} formError{/if}" id="contentItemIDDiv">
		<div class="formFieldLabel">
			<label for="contentItemID">{lang}wsis.acp.theme.module.bookNavigation.contentItemID{/lang}</label>
		</div>
		<div class="formField">
		...
		<div class="formFieldDesc hidden" id="contentItemIDHelpMessage">
			<p>{lang}wsis.acp.theme.module.bookNavigation.contentItemID.description{/lang}</p>
		</div>
	</div>
