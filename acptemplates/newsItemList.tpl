...
<div class="mainHeadline">
	<img src="{@RELATIVE_MOXEO_DIR}icon/newsItemL.png" alt="" />
	<div class="headlineContainer">
		<h2>{lang}moxeo.acp.news.item.view{/lang}</h2>
	...
	<fieldset>
		...
		<div class="formElement" id="newsArchiveDiv">
			<div class="formFieldLabel">
				<label for="newsArchiveChange">{lang}moxeo.acp.news.archive{/lang}</label>
			</div>
			<div class="formField">
			...
			<div class="formFieldDesc hidden" id="newsArchiveHelpMessage">
				{lang}moxeo.acp.news.archive.description{/lang}
			</div>
		</div>
...
{if $newsArchiveID}
						...
						<tr class="{cycle values="container-1,container-2"}">
							<td class="columnIcon">
								{if $this->user->getPermission('admin.moxeo.canEnableNewsItem')}
									...
									{else}
										<a href="index.php?action=NewsItemEnable&amp;newsItemID={@$newsItem->newsItemID}&amp;packageID={@PACKAGE_ID}{@SID_ARG_2ND}"><img src="{@RELATIVE_WCF_DIR}icon/disabledS.png" alt="" title="{lang}moxeo.acp.news.item.enable{/lang}" /></a>
									{/if}
								{else}
									{if $newsItem->enabled}
										<img src="{@RELATIVE_WCF_DIR}icon/enabledDisabledS.png" alt="" title="{lang}moxeo.acp.news.item.disable{/lang}" />
									{else}
	...
	{else}
		<div class="border content">
			<div class="container-1">
				<p>{lang}moxeo.acp.news.item.view.count.noNewsItems{/lang}</p>
			</div>
		</div>
	{/if}
{/if}
