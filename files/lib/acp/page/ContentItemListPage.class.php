...
class ContentItemListPage extends AbstractPage {
	...
	public $neededPermissions = array('admin.moxeo.canEditContentItem', 'admin.moxeo.canDeleteContentItem');
	...
	public function show() {
		// enable menu item
		WCFACP::getMenu()->setActiveMenuItem('moxeo.acp.menu.link.content.contentItem.view');
