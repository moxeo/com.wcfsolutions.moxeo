<?php
// moxeo imports
require_once(MOXEO_DIR.'lib/acp/form/NewsItemAddForm.class.php');
...
class NewsItemEditForm extends NewsItemAddForm {
	// system
	public $activeMenuItem = 'moxeo.acp.menu.link.content.newsItem';
	public $neededPermissions = 'admin.moxeo.canEditNewsItem';
